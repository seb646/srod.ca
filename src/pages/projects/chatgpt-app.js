...
import MetaImage from "../../images/projects/chatgpt-app.png"

const chatgptAppPage = ({ location }) => (
  <>
    ...
    <main className="pt-nav">
      <div className="max-w-full px-10 md:px-20 xl:px-32 py-20">
          <div className="max-w-5xl mx-auto mb-10">
            <p className="text-xs font-semibold tracking-wide uppercase text-neutral-500 mb-6 space-x-2 flex items-center">
              ...
              <h1 className="mb-6 text-3xl xl:text-5xl font-bold text-neutral-800">Designing a mobile application for ChatGPT</h1>
          </div>
          <div className="max-w-5xl mx-auto">
              <div className="flex flex-col sm:flex-row justify-between text-neutral-600 space-y-6 sm:space-y-0">
                  ...
                  <div>
                    ...
                    <p>Class Project</p>
                    <p className="text-sm">INF353 @ University of Toronto</p>
                  </div>
                  <div>
                    <p className="font-medium text-black mb-2">Timeline</p>
                    <p>May 2023 &ndash; Aug 2023</p>
                  </div>
                  <div>
                    <p className="font-medium text-black mb-2">Links</p>
                    <a href="https://www.figma.com/proto/70t9zKnYCwG4pTZIY5zlCX/ChatGPT-Mobile-App?page-id=15%3A3312&type=design&node-id=15-3313&viewport=293%2C459%2C0.81&t=JvYoSItfFZjpqh23-1&scaling=scale-down&starting-point-node-id=15%3A3313&mode=design" className="flex items-center justify-left group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 mr-2">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" />
                        </svg>
                        <span className="group-hover:underline">Figma prototype</span>
                    </a>
                  </div>
              </div>
          </div>
      ...
      <div className="max-w-full px-10 md:px-20 xl:px-32 space-y-20 relative mb-10">
          <div className="max-w-5xl mx-auto border-t border-b py-8 flex justify-between">
            <Link to="/projects/united-states-of-surveillance" className="max-w-md group">
            ...
            <Link to="/projects/study-rooms" class="text-right max-w-md group">
 ...
 */
export const Head = ({ location }) => <Seo title="ChatGPT Mobile App" location={location} image={MetaImage}/>
