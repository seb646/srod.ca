...
import MetaImage from "../../images/projects/flip.png"
        ...
        <main className="pt-nav">
            <div className="max-w-full px-10 md:px-20 xl:px-32 py-20">
                <div className="max-w-5xl mx-auto mb-10">
                    ...
                    <h1 className="mb-6 text-3xl xl:text-5xl font-bold text-neutral-800">Teaching students to embrace, learn and bounce back from failure</h1>
                    <p className="text-xl text-neutral-600">The University of Toronto's Failure: Learning in Progress project researched how to teach students about failure. After writing publications and developing teaching materials, the project needed an open access platform to host their resources.</p>
                </div>
                <div className="max-w-5xl mx-auto">
                    <div className="flex flex-col sm:flex-row justify-between text-neutral-600 space-y-6 sm:space-y-0">
                        ...
                        <div>
                            ...
                            <p className="text-sm">Failure: Learning in Progress</p>
                        </div>
                        <div>
            ...
            <div className="max-w-full px-10 md:px-20 xl:px-32 space-y-20 relative mb-10">
                ...
                <div className="max-w-5xl mx-auto border-t border-b py-8 flex justify-between">
                    <Link to="/projects/geography-of-terror" className="max-w-md group">
                    ...
                    <Link to="/projects/kmdi" class="text-right max-w-md group">
