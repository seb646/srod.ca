...
import MetaImage from "../../images/research/deceptive-design.png"
    ...
    <main className="pt-nav">
      <div className="max-w-full px-10 md:px-20 xl:px-32 py-20">
          <div className="max-w-4xl mx-auto mb-10">
              <h1 className="mb-6 text-3xl xl:text-5xl font-bold text-slate-700">Teaching students to recognize and contextualize deceptive design</h1>
          ...
          <div className="max-w-4xl mx-auto">
              <div className="flex flex-col sm:flex-row justify-between text-gray-600 space-y-6 sm:space-y-0">
                  ...
                  <div>
                    <p className="font-medium text-black mb-2">Conference Poster</p>
                    <a href="https://assets.srod.ca/files/CDHI_dark_patterns_poster.pdf" className="flex items-center justify-left group">
                      ...
                      <span className="group-hover:underline">PDF file</span>
                    </a>
                  </div>
              </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto pb-20 space-y-10 relative">
          <div className="research-img overflow-hidden border border-gray-200 sm:rounded-3xl flex items-center justify-center relative will-change-transform">
              <StaticImage
