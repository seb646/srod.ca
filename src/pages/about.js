    ...
    <main className="pt-nav">
      <div className="max-w-full px-10 md:px-20 xl:px-32 pb-6">
          <div className="max-w-5xl mx-auto py-8">
              ...
              <p className="sm:text-lg text-neutral-600 mb-5">Currently, I work with <a href="https://mlml.io/m/sebastian-rodriguez/" className="border-b border-gray-600 hover:text-black hover:border-black transition-all duration-200">metaLAB</a> at Harvard University's Berkman Klein Center for Internet & Society to help teachers bring generative AI into their classrooms. I also hold positions with the University of Toronto's <Link to="/projects/learn-from-failure" className="border-b border-gray-600 hover:text-black hover:border-black transition-all duration-200">Failure: Learning in Progress</Link> project and <Link to="/projects/kmdi" className="border-b border-gray-600 hover:text-black hover:border-black transition-all duration-200">Knowledge Media Design Institute</Link>. I previously <Link to="/projects/deceptive-design" className="border-b border-gray-600 hover:text-black hover:border-black transition-all duration-200">investigated deceptive design</Link> as an undergraduate fellow for the University of Toronto's Critical Digital Humanities Initiative.</p>
